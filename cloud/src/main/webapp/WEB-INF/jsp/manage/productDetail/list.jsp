        ...
        layui.use(['form', 'table'], function () {
            ...
            table.render({
                ...
                cols: [[
                    ...
                    { field: 'num', title: '数量(卷)', align: "center" },
                    { field: 'len', title: '长度(卷/米)', align: "center" },
                    { field: 'width', title: '门幅', align: "center" },
                    { field: 'color', title: '颜色', align: "center" },
                    { field: 'spec', title: '规格', align: "center" },
                    { field: 'productTime', title: '生产时间', align: "center" },
                    { field: 'createDate', title: '录入时间', align: "center" },
                    { field: 'userName', title: '录入人员', align: "center" },
