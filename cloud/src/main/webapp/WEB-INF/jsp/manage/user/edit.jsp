            ...
            <body>
                <div class="layui-form layuimini-form">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="name" id="name" lay-verify="required" lay-reqtext="用户名不能为空"
                                value="${model.name}" class="layui-input">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="nameCN" id="nameCN" value="${model.nameCN}" class="layui-input">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="idCard" id="idCard" value="${model.idCard}" lay-verify="required"
                                lay-reqtext="身份证不能为空" class="layui-input">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label required">手机号</label>
                        <div class="layui-input-block">
                            <input type="text" name="phone" id="phone" value="${model.phone}" lay-verify="required"
                                lay-reqtext="手机号不能为空" class="layui-input">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label ">籍贯</label>
                        <div class="layui-input-block">
                            <input type="text" name="nativePlace" id="nativePlace" value="${model.nativePlace}"
                                class="layui-input">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <select id="roleId" name="roleId" lay-filter="roleId" lay-verify="required" lay-reqtext="请选择角色"  lay-search></select>
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item department">
                        ...
                        <div class="layui-input-block">
                            <select id="departmentId" name="departmentId" lay-filter="departmentId" lay-verify=""
                                lay-search></select>
                        </div>
                    </div>
                    <div class="layui-form-item company">
                        ...
                        <div class="layui-input-block">
                            <select id="companyId" name="companyId" lay-filter="companyId" lay-verify=""
                                lay-search></select>
                        </div>
                    </div>
                    <div class="layui-form-item staff">
                        ...
                        <div class="layui-input-block">
                            <input type="radio" name="isStay" lay-filter="isStay" value="0" title="否" checked>
                            <input type="radio" name="isStay" lay-filter="isStay" value="1" title="是">
                    ...
                    <div class="layui-form-item driveFlag">
                        ...
                        <div class="layui-input-block">
                            <input type="radio" name="isDriving" lay-filter="isDriving" value="0" title="否" checked>
                            <input type="radio" name="isDriving" lay-filter="isDriving" value="1" title="是">
                        </div>
                    </div>
                    <div class="layui-form-item  driving">
                        <label class="layui-form-label ">自驾车牌号码</label>
                        <div class="layui-input-block">
                            <input type="text" name="licensePlate" id="licensePlate" value="${model.licensePlate}"
                                class="layui-input">
                        </div>
                    </div>
                    <div class="layui-form-item">
                ...
                <script>
                    layui.use(['form', 'laydate'], function () {
                        ...
                        form.on('select(roleId)', function (data) {
                            if (data.value == '5') {
                                $('.staff').show();
                                if ($('input[name=isStay]:checked').val() == '0') {
                                    $('.driveFlag').show();
                                }
                        ...
                        form.on('submit(saveBtn)', function (data) {
                            ...
                            if (data.roleId == '4' || data.roleId == '5') {
                                ...
                                if (data.roleId == '3' || data.roleId == '2') {
